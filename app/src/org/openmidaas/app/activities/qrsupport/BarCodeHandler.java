...
public final class BarCodeHandler extends Handler implements IConstants {
  ...
  public BarCodeHandler(QRCodeScanFragment activity,
                         Collection<BarcodeFormat> decodeFormats,
                         String characterSet,
                         CameraManager cameraManager) {
    this.activity = activity;
    Logger.info(getClass(), "Activity: "+activity);
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case AUTO_FOCUS:
    	Logger.debug(getClass(), "Got auto-focus message");
      ...
      case RESTART_PREVIEW:
        Logger.debug(getClass(), "Got restart preview message");
        restartPreviewAndDecode();
        break;
      case DECODE_COMPLETE:
    	Logger.debug(getClass(), "Got decode succeeded message");
        state = State.SUCCESS;
